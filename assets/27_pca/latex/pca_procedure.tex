...
\begin{tikzpicture}[>=stealth]
    ...
    \begin{scope}[xshift = 11.7cm, yshift = -7cm]
        ...
        \begin{scope}[rotate = 60]
                \foreach \x/\y in {0.97/-0.54, -1.64/0.16, 0.18/-0.01, 0.58/0.13, -0.75/-0.22, -1.28/-0.04, 0.77/0.15, -1.38/-0.06, 1.26/-0.68, -0.06/0.14, 0.52/-0.55, 0.48/0.01, -0.72/0.12, 0.59/-0.09, -0.77/-0.04, 1.72/-0.01, -0.93/0.00, -0.86/0.08, 1.56/0.07, 0.07/0.08, -0.89/-0.13, -0.83/0.07, 0.04/-0.00, 2.35/0.15, 1.37/0.05, -1.98/0.18, -1.76/-0.01, -2.25/-0.11, 0.00/0.65, -0.34/0.23, -0.26/0.11, -0.90/0.08, -0.78/-0.13, -0.19/0.03, 1.49/0.36, -0.84/-0.32, 0.45/0.17, -0.19/0.12, 0.60/-0.18, -1.59/0.33, 1.35/-0.23, 0.22/-0.10, -0.16/-0.19, -1.65/-0.23, 1.25/-0.00, -1.14/0.38, -0.97/0.04, -1.91/0.04, 0.75/-0.24, -0.19/-0.34, }
                {\draw [fill = blue!50] (\x, \y) circle (1mm); }
        \end{scope}
