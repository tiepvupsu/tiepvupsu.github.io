...
\include{5_kmeans2}
\include{6_knn}
\include{7_gradientdescent}
\include{8_gradientdescent2}
\include{9_perceptron}
\include{10_logisticregression}

\include{11_featureengineering}
\include{12_binaryclassifiers}
\include{13_softmax}
\include{14_mlp}
