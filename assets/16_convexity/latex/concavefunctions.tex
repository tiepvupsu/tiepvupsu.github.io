...
\begin{scope}[xshift = \d cm ]
	\draw [-> ](-1, 0) -- (3, 0);
	\draw [-> ](0,-1) -- (0, 3);
	\draw[scale=0.5,domain=0:4,variable=\x,blue] plot ({\x},{2*\x^.5});
	\node [scale = 1.6] at (0, -1.5) {$y = 2x^2$};
\end{scope}

\begin{scope}[xshift = 2*\d cm ]
	\draw [-> ](-1, 0) -- (3, 0);
	\draw [-> ](0,-1) -- (0, 3);
	\draw[scale=0.5,domain=0.25:4,variable=\x,blue] plot ({\x},{2*ln(\x)});
...
\begin{scope}[xshift = 16 cm ]
	\draw [-> ](-3, 0) -- (2, 0);
	\draw [-> ](0,-1) -- (0, 3);
	\draw[scale=0.5,domain=0:2,variable=\x,blue] plot ({\x},{3-\x*\x});
	\draw[scale=0.5,domain=-4:0,variable=\x,blue] plot ({\x},{3+\x});
...
% 	\draw [-> ](-2, 0) -- (2, 0);
% 	\draw [-> ](0,-1) -- (0, 3);
% 	\draw[scale=0.5,domain=-3:1.5,variable=\x,blue] plot ({\x},{exp(\x)});
...
% 	\draw [-> ](-2, 0) -- (2, 0);
% 	\draw [-> ](0,-1) -- (0, 3);
% 	\draw[scale=0.5,domain=.25:3,variable=\x,blue] plot ({\x},{\x^-1});
