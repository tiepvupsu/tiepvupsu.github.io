...
\begin{document}
    ...
    \begin{scope}[xshift = \t*\d cm]        
       % \def\p{16}
        \draw [fill = gray!50, draw = white] (1, 0) -- (0, 1) -- (-1, 0) -- (0, -1) -- cycle;
        \draw[blue, thick, fill = white, scale=1,domain=0:90,samples=100,smooth,variable=\t]
    ...
    \begin{scope}[xshift = \t*\d cm, yshift = -4cm]        
       % \def\p{16}
        \draw [fill = gray!50, draw = gray!50] (1, 0) -- (0, 1) -- (-1, 0) -- (0, -1) -- cycle;
        \draw[blue, thick, fill = gray!50, scale=1,domain=0:90,samples=100,smooth,variable=\t]
          plot({-1*cos(\t)^(\p)},{1*sin(\t)^(\p)});
        \draw[blue, thick,fill = gray!50, scale=1,domain=0:90,samples=100,smooth,variable=\t]
          plot({-1*cos(\t)^(\p)},{-1*sin(\t)^(\p)});
        \draw[blue, thick,fill = gray!50, scale=1,domain=0:90,samples=100,smooth,variable=\t]
    ...
    \end{scope}
     ...
     \begin{scope}[yshift = -4cm, xshift = 4*\d cm]
        \draw [blue, thick, fill = gray!50] (-1, 1) -- (1, 1) -- (1, -1) -- (-1, -1) --cycle;
    ...
    \node at (2*\d, -2) {$p < 1$: nonconvex sets};
    \node at (2*\d, -6) {$p \geq 1$: convex sets};
    % \node at (-3, 0) {$p < 1$};
