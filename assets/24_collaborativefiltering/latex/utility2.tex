...
\begin{tikzpicture}
    ...
    \nnn{0}{1}{white}{$\mathbf{i}_1$};
    \nnn{0}{2}{white}{$\mathbf{i}_2$};
    \nnn{0}{3}{white}{$\mathbf{i}_3$};
    \nnn{0}{4}{white}{$\mathbf{i}_4$};
    \nnn{0}{5}{white}{$\mathbf{i}_5$};
    ...
    \begin{scope}[xshift = 18cm, yshift = 0cm]
        ...
        \nnn{0}{1}{white}{$\mathbf{u}_1$};
        \nnn{0}{2}{white}{$\mathbf{u}_2$};
        \nnn{0}{3}{white}{$\mathbf{u}_3$};
        \nnn{0}{4}{white}{$\mathbf{u}_4$};
        \nnn{0}{5}{white}{$\mathbf{u}_5$};
        \nnn{0}{6}{white}{$\mathbf{u}_6$};
        \nnn{0}{7}{white}{$\mathbf{u}_7$};
    \end{scope}
