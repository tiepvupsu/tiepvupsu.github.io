...
% \node [lable=below:a, draw] at (10, 10);
\node[mynode, fill = blue!50!black] (n1) {};
\node[mynode, fill = red!50!black, anchor = west, right=.1cm of n1.east] (n2) {};
\node[mynode, fill = green!50!black, anchor = west, right=.1cm of n2.east] (n3) {};
\node[mynode, fill = yellow!50!black, anchor = west, right=.1cm of n3.east] (n4) {};
\node[mynode, fill = purple!50!black, anchor = west, right=.1cm of n4.east] (n5) {};
\end{tikzpicture}
\end{document}