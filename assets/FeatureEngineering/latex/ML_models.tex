...
\node (train) at (-2, -2) [draw, fill = blue!3!white, anchor = south west, minimum width = 15.5cm, minimum height = 7cm] {};
...
\node (fea) [mynode, draw, anchor = west, right =of raw_train.east, minimum width = 3cm, minimum height = 3cm, text width = 2.5cm, fill =green!15] {Feature Extraction \\ (Feature Engineering)};
...
\node (ml) [draw, anchor = west, right =of ex_fea.east, minimum width = 3cm, text width = 2.5cm, minimum height = 3cm, align = center, fill = green!15] {Classification, Regression, Clustering,... Algorithms};
...
%%%%%%%%%%%%%%%%%%%
\node (test) at (-2, -9) [draw, fill = blue!3!white, anchor = south west, minimum width = 15.5cm, minimum height = 6cm] {};
\node at (1, -8) [scale = 2] {{TESTING PHASE}};
...
\node (fea_test) [mynode, draw, anchor = west, right =of raw_test.east, minimum width = 3cm, minimum height = 3cm, text width = 2.5cm, fill =red!15] {Feature Extraction \\ (Feature Engineering)};
...
\node (ml_test) [draw, anchor = west, right =of ex_test_fea.east, minimum width = 3cm, text width = 2.5cm, minimum height = 3cm, align = center, fill = red!15] {Classification, Regression, Clustering,... Algorithms};
...
\draw [ultra thick,->, blue, dashed](fea) -- (fea_test);
\draw [ultra thick,->, blue, dashed](ml) -- (ml_test);
