...
\begin{tikzpicture}[shorten >=1pt,draw=black,thick, node distance=\layersep, >= stealth]
    ...
    \begin{scope}
        ...
        % %%%%%%%%%%%%%% INPUT LAYER %%%%%%%%%%%%%%%%%%%%%%
        \node [green!50!black] at (0, -2.5) {Input layer};
        ...
        % %%%%%%%%%%%%%% HIDDEN LAYER 1 %%%%%%%%%%%%%%%%%%%%%%
        \node [blue!50!black] at (1*\layersep, -2.5) {Hidden layer};
        ...
        % %%%%%%%%%%%%%% OUTPUT LAYER 2 %%%%%%%%%%%%%%%%%%%%%%
        \node [red!50!black] at (2*\layersep, -2.5) {Output};
        \node [red!50!black] at (2*\layersep, -3) {Softmax Regression};
        \draw [white, fill = red!15] (2*\layersep-\pad, -.5*\nth) rectangle (2*\layersep + \pad, .5*\nth);
        \foreach \name / \y in {1,...,\nth}
            \node[output neuron] (O-\name) at (2*\layersep, \y - 0.5*\nth -.5) {};
