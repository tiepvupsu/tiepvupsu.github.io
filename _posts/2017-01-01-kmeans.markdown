...
summary: Trong thuật toán K-means clustering, chúng ta không biết nhãn (label) của từng điểm dữ liệu. Mục đích là làm thể nào để phân dữ liệu thành các cụm (cluster) khác nhau sao cho <em>dữ liệu trong cùng một cụm có tính chất giống nhau</em>.
---
...
- [4. Thảo luận](#-thao-luan)
    - [Hạn chế](#han-che)
        ...
        - [Các cluster cần có dạng hình tròn \(tuân theo phân phối chuẩn và ma trận hiệp phương sai là ma trận đường chéo có các điểm trên đường chéo giống nhau\)](#cac-cluster-can-co-dang-hinh-tron-tuan-theo-phan-phoi-chuan-va-ma-tran-hiep-phuong-sai-la-ma-tran-duong-cheo-co-cac-diem-tren-duong-cheo-giong-nhau)
