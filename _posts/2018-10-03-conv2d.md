...
<div class="thecap">Hình 5. (a) Ảnh có nhiễu. (b) Giảm nhiễu bằng bộ lọc trung bình \(f = 3\). (c) Giảm nhiễu và làm mờ với bộ lọc trung bình \(f = 5\)</div>
</div>
<hr>
...
Việc tìm các cạnh có hướng bất kỳ cũng có thể được thực hiện bằng các bộ lọc phù hợp. (Mạng neuron tích chập có thể tự tìm ra các bộ lọc phù hợp này dựa trên mỗi bài toán.)
