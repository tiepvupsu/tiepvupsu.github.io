...
### Sever 
Tên miền của blog là `github.io`, các bạn quen với git và github có lẽ đều biết tới trang [https://github.com/ ](https://github.com/) - là một nơi lưu các projects, có hỗ trợ quản lý version và cũng là một Internet hosting service. Tôi dùng trang này để lưu blog vì việc update bài mới rất thuận tiện. Toàn bộ source code của blog này đều có thể xem [tại đây](https://github.com/tiepvupsu/tiepvupsu.github.io). 
