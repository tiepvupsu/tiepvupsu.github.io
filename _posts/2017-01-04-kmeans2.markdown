...
layout: post
comments: true
title:  "K-means Clustering: Simple Applications"
...
- [Object Segmentation \(tách vật thể trong ảnh\)](#object-segmentation-tach-vat-the-trong-anh)
    - [Đặt vấn đề](#dat-van-de)
    - [Lên ý tưởng](#len-y-tuong)
    - [Làm việc trên Python](#lam-viec-tren-python-1)
- [Image Compression \(nén ảnh và nén dữ liệu nói chung\)](#image-compression-nen-anh-va-nen-du-lieu-noi-chung)
- [Thảo luận](#thao-luan)
