...
layout: post
comments: true
title:  "Bài 27: Principle Component Analysis"
title2:  "26. Principle Component Analysis"
date:   2017-06-15 15:22:00
permalink: 2017/06/15/svd/
mathjax: true
...
- [2. Một chút toán](#-mot-chut-toan)
    ...
    - [2.2. Biễu diễn vector trong hệ cơ sở khác](#-bieu-dien-vector-trong-he-co-so-khac)
    - [2.3. Trace](#-trace)
...
<a name="-bieu-dien-vector-trong-he-co-so-khac"></a>

### 2.2. Biễu diễn vector trong hệ cơ sở khác
...
Có thể nhận thấy rằng, việc chuyển đổi hệ cơ sở sử dụng ma trận trực giao có thể được coi như một phép xoay, nhưng thay vì xoay vector, ta xoay trục toạ độ.
...
\sigma &=& \frac{1}{N} \sum_{n=1}^N (x_n - \bar{x})^2
\end{eqnarray}
\\]
...
<table width = "100%" style = "border: 0px solid white">
    ...
    <tr >
        ...
        c)
         ...
         <td width="40%" style = "border: 0px solid white" align = "justify">
        Hình 2: Ví dụ về kỳ vọng và phương sai. a) Trong không gian 1 chiều. b) Không gian 2 chiều mà hai chiều không tương quan. Trong trường hợp này, ma trận hiệp phương sai là ma trận đường chéo với hai phần tử trên đường chéo  là \(\sigma_1, \sigma_2\), đây cũng chính là hai trị riêng của ma trận hiệp phương sai và là phương sai của mỗi chiều dữ liệu. c) Dữ liệu trong không gian hai chiều có tương quan. Theo mỗi chiều, ta có thể tính được kỳ vọng và phương sai. Phương sai càng lớn thì dữ liệu trong chiều đó càng biến đổi nhiều. Trong ví dụ này, dữ liệu theo chiều thứ hai biến đổi nhiều hơn so so với chiều thứ nhất.
          </td>
    </tr>
</table>
</div>
...
<div class = "thecap" align = "left">Hình 4: Các bước thực hiện PCA. </div>
<hr>
