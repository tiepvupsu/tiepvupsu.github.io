...
- [3. Backpropagation](#-backpropagation)
    - [3.1. Backpropagation cho Stochastic Gradient Descent](#-backpropagation-cho-stochastic-gradient-descent)
        - [3.1.1. Đạo hàm theo từng hệ số \newline(w_{ij}^{\(l\)}, b_{i}^{\(l\)}\newline)](#-dao-ham-theo-tung-he-so-\\wij^l-bi^l\\)
        - [3.1.2. Đạo hàm theo ma trận \newline(\mathbf{W}^{\(l\)}, \mathbf{b}^{\(l\)}\newline)](#-dao-ham-theo-ma-tran-\newlinemathbfw^l-\mathbfb^l\\)
...
<a name="-dao-ham-theo-ma-tran-\newlinemathbfw^l-\mathbfb^l\\"></a>
